...
INSERT INTO `devices` VALUES (15,'aa:aa:aa:aa:aa:aa','Test device',1,NULL,NULL,NULL,NULL,NULL,159,'2013-03-16 05:34:13','2013-03-18 13:58:18'),(16,'E4:11:5B:29:67:2B','My Tablet',1,'2013-03-16 17:46:18','2013-03-16 17:42:55','127.0.1.1','127.0.1.1','User E4:11:5B:29:67:2B account disabled',159,'2013-03-16 13:21:12','2013-03-18 13:39:04');
...
INSERT INTO `nas` VALUES (4,'192.168.1.100','shortname','other',NULL,'shortname',NULL,NULL,'RADIUS Client','direct',0,0,'','','off',600,600,0,3600,0,NULL,NULL,'logo.jpg',90,'2013-02-13 14:32:45','2013-02-13 14:32:45'),(5,'g','g','other',NULL,'g',NULL,NULL,'RADIUS Client','direct',0,0,'','','off',600,600,0,3600,0,NULL,NULL,'logo.jpg',44,'2013-03-11 05:57:52','2013-03-11 05:57:52');
...
) ENGINE=MyISAM AUTO_INCREMENT=72379 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `radcheck` VALUES (152,'zz','Rd-User-Type',':=','device'),(154,'zz','Rd-Device-Owner',':=','koos'),(155,'zz','User-Profile',':=','Krillie'),(156,'zz','Rd-Cap-Type',':=','hard'),(158,'rviljoen','Cleartext-Password',':=','rviljoen'),(163,'rviljoen','Rd-User-Type',':=','user'),(182,'koos','Rd-User-Type',':=','user'),(183,'koos','Rd-Realm',':=','realm_for_dp'),(184,'koos','User-Profile',':=','Krillie'),(185,'koos','Rd-Cap-Type',':=','hard'),(188,'koos','Rd-Account-Disabled',':=','0'),(189,'koos','Cleartext-Password',':=','gooihom'),(244,'aa:aa:aa:aa:aa:aa','Rd-User-Type',':=','device'),(245,'aa:aa:aa:aa:aa:aa','Rd-Realm',':=','realm_for_dp'),(246,'aa:aa:aa:aa:aa:aa','Rd-Device-Owner',':=','rviljoen'),(247,'aa:aa:aa:aa:aa:aa','User-Profile',':=','Device'),(248,'aa:aa:aa:aa:aa:aa','Rd-Cap-Type',':=','hard'),(250,'E4:11:5B:29:67:2B','Rd-User-Type',':=','device'),(251,'E4:11:5B:29:67:2B','Rd-Realm',':=','realm_for_dp'),(269,'rviljoen','Rd-Account-Disabled',':=','0'),(286,'rviljoen','User-Profile',':=','Owner'),(287,'rviljoen','Rd-Realm',':=','realm_for_dp'),(288,'rviljoen','Expiration',':=','18 Mar 2014'),(289,'rviljoen','Rd-Account-Activation-Time',':=','18 Mar 2013'),(290,'rviljoen','Rd-Cap-Type',':=','hard'),(358,'E4:11:5B:29:67:2B','User-Profile',':=','Device'),(359,'E4:11:5B:29:67:2B','Rd-Device-Owner',':=','rviljoen'),(360,'E4:11:5B:29:67:2B','Expiration',':=','28 Mar 2013'),(361,'E4:11:5B:29:67:2B','Rd-Account-Activation-Time',':=','20 Mar 2013'),(362,'E4:11:5B:29:67:2B','Rd-Cap-Type',':=','soft'),(363,'E4:11:5B:29:67:2B','Rd-Account-Disabled',':=','0'),(364,'aa:aa:aa:aa:aa:aa','Rd-Account-Disabled',':=','0');
...
-- Dump completed on 2013-03-18 14:09:29
