...
INSERT INTO `nas` VALUES (49,'127.0.0.1','localhost','','CoovaChilli',3799,'testing123','','','RADIUS Client','direct',1,0,0,'','','ping',600,600,'2013-07-05 21:20:04',0,3600,0,-25.7381389511493,28.3009659048564,'logo.jpg',44,'2013-05-25 12:48:54','2013-07-05 21:20:04'),(55,'10.120.0.1','CoovaAP-01','Dirk-AP','CoovaChilli-Heartbeat',NULL,'testing123','','00-1D-7E-BC-C2-12','RADIUS Client','dynamic',0,0,0,'NAS-Identifier','Dirk-AP-Home','off',600,600,'2013-07-02 20:21:33',0,3600,0,NULL,NULL,'logo.jpg',44,'2013-07-02 10:00:59','2013-07-02 20:21:18');
...
) ENGINE=InnoDB AUTO_INCREMENT=7686 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `radcheck` VALUES (381,'dvdwalt','Cleartext-Password',':=','dvdwalt'),(382,'dvdwalt','Rd-User-Type',':=','user'),(420,'dvdwalt','User-Profile',':=','Profile-A'),(421,'dvdwalt','Rd-Realm',':=','Residence Inn'),(422,'dvdwalt','Rd-Cap-Type',':=','soft'),(474,'dvdwalt','Rd-Account-Disabled',':=','0'),(475,'dvdwalt','Rd-Not-Track-Auth',':=','1');
...
-- Dump completed on 2013-07-05 21:34:55
