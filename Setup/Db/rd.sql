...
INSERT INTO `nas` VALUES (49,'127.0.0.1','localhost','','CoovaChilli',3799,'testing123','','','RADIUS Client','direct',1,0,0,'','','ping',600,600,'2013-07-01 13:20:04',0,3600,0,-25.7381389511493,28.3009659048564,'logo.jpg',44,'2013-05-25 12:48:54','2013-07-01 13:20:04');
...
CREATE TABLE `phrase_values` (
  ...
  `modified` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1536 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2013-07-01 13:25:21
